...
The _Delta Index_ measures the concentration of a minority group.
...
necessarily equvalent. A .5 Gini Coefficient is not the same as a .5 Delta 
Index, for example. However, for simplicity, we will treat them as more or less
comparable.
...
(`r round(max.delta[1, 2], digits = 2)`), as the most segregated.
