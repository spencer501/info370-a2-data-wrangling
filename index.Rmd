...
dynamics withing a region, such as the size of two groups being compared.
...
the the total minority population across all regions, and ${t}_{i}$ is the total
...
indicating more segregationThe isolation index is determined by looking at
the proportion of of minority members $\left( \frac{{x}_{i}}{X} \right)$ and
...
the context of the total minority proportion in a city $P$.
